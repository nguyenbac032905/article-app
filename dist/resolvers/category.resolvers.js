...
exports.resolversCategory = {
    Query: {
        getListCategory: () => __awaiter(void 0, void 0, void 0, function* () {
            const categories = yield categories_model_1.default.find({ deleted: false });
            return categories;
        }),
        getCategory: (_, args) => __awaiter(void 0, void 0, void 0, function* () {
            const { id } = args;
            const category = yield categories_model_1.default.findOne({ deleted: false, _id: id });
            return category;
        })
    },
    Article: {
    ...
    Mutation: {
        ...
        deleteCategory: (_, args) => __awaiter(void 0, void 0, void 0, function* () {
            const { id } = args;
            yield categories_model_1.default.updateOne({ _id: id }, { $set: { deleted: true } });
            return "Da xoa";
        }),
        updateCategory: (_, args) => __awaiter(void 0, void 0, void 0, function* () {
            const { id, category } = args;
            yield categories_model_1.default.updateOne({ _id: id }, category);
            const record = yield categories_model_1.default.findOne({ _id: id });
            return record;
        }),
    }
};
